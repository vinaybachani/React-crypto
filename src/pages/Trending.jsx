...
const Trending = () => {
    const { trendData, resetTrendingResult } = useContext(TrendContext);
    return (
        <section className='lg:w-[80%] w-[90%] h-full flex flex-col  mb-24 mt-16 relative'>
            ...
            <button onClick={resetTrendingResult} className='w-[2rem] ml-4 -top-10 right-0 absolute hover:scale-110 transition-all transition-ease'>
                <svg
